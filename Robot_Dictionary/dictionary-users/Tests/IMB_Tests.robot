...
${ENVIRONMENT} =  qa
${BROWSER} =  ff
### Dictionaries are creates with &{name} when using them in the script are considered variables therfore accessed with $ sign
## Dictionaries are always defined as Key and Values
